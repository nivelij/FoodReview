...
This application is a simple food recommendation, and the purpose of this app is to demonstrate how elasticsearch can become really handy in generating list of results based on certain keyword(s).
